...
.field public t:Landroid/support/v7/widget/ActionMenuPresenter;

.field public u:La/b/i/f/a/v$a;

.field public v:La/b/i/f/a/l$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-virtual {p0, v0}, La/b/i/g/oa;->setBaselineAligned(Z)V
    ...
    .line 6
    iput p2, p0, Landroid/support/v7/widget/ActionMenuView;->z:I
...
.method public a(La/b/i/f/a/l;)V
    ...
    .line 18
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->p:La/b/i/f/a/l;
...
.method public a(La/b/i/f/a/v$a;La/b/i/f/a/l$a;)V
    ...
    .line 19
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->u:La/b/i/f/a/v$a;

    .line 20
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->v:La/b/i/f/a/l$a;
...
.method public a(La/b/i/f/a/p;)Z
    ...
    .line 16
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->p:La/b/i/f/a/l;
...
.method public bridge synthetic generateDefaultLayoutParams()La/b/i/g/oa$a;
    .locals 1
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)La/b/i/g/oa$a;
    .locals 0
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)La/b/i/g/oa$a;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    .line 3
    new-instance v1, La/b/i/f/a/l;

    invoke-direct {v1, v0}, La/b/i/f/a/l;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:La/b/i/f/a/l;

    .line 4
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->p:La/b/i/f/a/l;
    ...
    invoke-virtual {v1, v2}, La/b/i/f/a/l;->a(La/b/i/f/a/l$a;)V
    ...
    .line 7
    iput-boolean v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->m:Z

    .line 8
    iput-boolean v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->n:Z

    .line 9
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->u:La/b/i/f/a/v$a;
    ...
    .line 10
    :goto_0
    iput-object v1, v0, La/b/i/f/a/b;->e:La/b/i/f/a/v$a;
    ...
    .line 13
    iput-object p0, v0, La/b/i/f/a/b;->h:La/b/i/f/a/w;

    .line 14
    iget-object v0, v0, La/b/i/f/a/b;->c:La/b/i/f/a/l;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuView;->a(La/b/i/f/a/l;)V
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    iget-object v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->j:Landroid/support/v7/widget/ActionMenuPresenter$d;
    ...
    .line 5
    :cond_0
    iget-boolean v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->l:Z

    if-eqz v1, :cond_1

    .line 6
    iget-object v0, v0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Landroid/graphics/drawable/Drawable;
...
.method public onLayout(ZIIII)V
    ...
    .line 1
    iget-boolean v5, v0, Landroid/support/v7/widget/ActionMenuView;->w:Z
    ...
    .line 2
    iget v5, v0, La/b/i/g/oa;->d:I

    if-ne v5, v6, :cond_0

    .line 3
    invoke-virtual {v0, v1, v2, v3, v4}, La/b/i/g/oa;->b(IIII)V

    goto :goto_0

    .line 4
    :cond_0
    invoke-virtual {v0, v1, v2, v3, v4}, La/b/i/g/oa;->a(IIII)V
    ...
    .line 7
    invoke-virtual/range {p0 .. p0}, La/b/i/g/oa;->getDividerWidth()I
    ...
    .line 13
    iget-boolean v14, v12, Landroid/support/v7/widget/ActionMenuView$c;->c:Z
    ...
    .line 15
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ActionMenuView;->d(I)Z
...
.method public onMeasure(II)V
    ...
    :goto_0
    iput-boolean v2, v0, Landroid/support/v7/widget/ActionMenuView;->w:Z

    .line 3
    iget-boolean v2, v0, Landroid/support/v7/widget/ActionMenuView;->w:Z

    if-eq v1, v2, :cond_1

    .line 4
    iput v4, v0, Landroid/support/v7/widget/ActionMenuView;->x:I
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActionMenuView;->p:La/b/i/f/a/l;

    if-eqz v2, :cond_2

    iget v6, v0, Landroid/support/v7/widget/ActionMenuView;->x:I

    if-eq v1, v6, :cond_2

    .line 7
    iput v1, v0, Landroid/support/v7/widget/ActionMenuView;->x:I

    .line 8
    invoke-virtual {v2, v5}, La/b/i/f/a/l;->b(Z)V
    ...
    .line 25
    iget v5, v0, Landroid/support/v7/widget/ActionMenuView;->z:I
    ...
    .line 35
    :goto_4
    invoke-static {v13, v11, v4, v7, v9}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/View;IIII)I
    ...
    .line 46
    iget v10, v12, Landroid/support/v7/widget/ActionMenuView$c;->d:I
    ...
    .line 47
    iget-boolean v1, v12, Landroid/support/v7/widget/ActionMenuView$c;->g:Z
    ...
    .line 49
    :goto_b
    iget v1, v12, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    const/4 v2, 0x1

    add-int/2addr v1, v2

    iput v1, v12, Landroid/support/v7/widget/ActionMenuView$c;->d:I

    .line 50
    iput-boolean v2, v12, Landroid/support/v7/widget/ActionMenuView$c;->h:Z
    ...
    .line 79
    invoke-virtual/range {p0 .. p2}, La/b/i/g/oa;->d(II)V

    goto :goto_17

    .line 80
    :cond_2a
    invoke-virtual/range {p0 .. p2}, La/b/i/g/oa;->c(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    .line 2
    iput-boolean p1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->u:Z
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 4
    invoke-virtual {v1, p1}, La/b/i/g/t;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 6
    iput-object p1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->k:Landroid/graphics/drawable/Drawable;
...
.method public setPresenter(Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    .line 3
    iput-object p0, p1, La/b/i/f/a/b;->h:La/b/i/f/a/w;

    .line 4
    iget-object p1, p1, La/b/i/f/a/b;->c:La/b/i/f/a/l;

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ActionMenuView;->a(La/b/i/f/a/l;)V
