...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 2
    iput v2, p0, Landroid/support/v7/widget/RecyclerView$s$a;->d:I
    ...
    .line 9
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$s$a;->e:Landroid/view/animation/Interpolator;
    ...
    .line 10
    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->na:Landroid/support/v7/widget/RecyclerView$v;

    iget v0, p0, Landroid/support/v7/widget/RecyclerView$s$a;->a:I

    iget v3, p0, Landroid/support/v7/widget/RecyclerView$s$a;->b:I

    .line 11
    invoke-virtual {p1, v0, v3, v1, v1}, Landroid/support/v7/widget/RecyclerView$v;->a(IIII)I

    move-result v4

    invoke-virtual {p1, v0, v3, v4}, Landroid/support/v7/widget/RecyclerView$v;->a(III)V
    ...
    iget v3, p0, Landroid/support/v7/widget/RecyclerView$s$a;->a:I

    iget v4, p0, Landroid/support/v7/widget/RecyclerView$s$a;->b:I

    invoke-virtual {p1, v3, v4, v0}, Landroid/support/v7/widget/RecyclerView$v;->a(III)V
    ...
    iget v4, p0, Landroid/support/v7/widget/RecyclerView$s$a;->a:I

    iget v5, p0, Landroid/support/v7/widget/RecyclerView$s$a;->b:I

    invoke-virtual {p1, v4, v5, v0, v3}, Landroid/support/v7/widget/RecyclerView$v;->a(IIILandroid/view/animation/Interpolator;)V
